---
title: "upstream"
description: "Outbound WebSocket vendor connection: `upstream` is the client dual of `socket`, with config-resolved dial, declared auth and a typed wire mapping."
---
