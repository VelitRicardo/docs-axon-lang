---
title: "synth"
description: "Runtime tool synthesis policy: `synth` sets the risk ceiling, language, mandatory WASM sandbox and review under which a savant writes and runs a tool."
---
