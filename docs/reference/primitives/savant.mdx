---
title: "savant"
description: "Long-horizon autonomous research: `savant` combines memory, a mandatory compute budget and inference engines into an interruptible, fail-closed loop."
---
