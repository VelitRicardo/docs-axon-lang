---
title: "rotate"
description: "Secret rotation verb: `rotate` renews matching entries of a `backend: secrets` store, one mediated tool call per key; the value never enters the program."
---
