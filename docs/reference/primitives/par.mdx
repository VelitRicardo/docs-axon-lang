---
title: "par"
description: "Parallel fan-out: `par` runs its branches concurrently with a real `join_all` and joins the results; branch tool calls share the channel semaphore."
---
