---
title: "document"
description: "Generate DOCX, PPTX and XLSX: `document` declares a compile-time-checked structure and refuses unattributed values below `believe` in assertive slots."
---
