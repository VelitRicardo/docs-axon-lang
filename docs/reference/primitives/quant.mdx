---
title: "quant"
description: "Quantum bridge block: `quant` lifts a continuous tensor into a Hilbert space and yields a declared observable's expectation (OSS simulator, n≤10)."
---
