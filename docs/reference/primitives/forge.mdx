---
title: "forge"
description: "Creative synthesis block: `forge` runs a four-phase Poincaré-Hadamard process with a measured, fail-closed novelty guarantee, so an LLM can create."
---
