---
title: "navigate"
description: "Deterministic knowledge navigation over three real engines (MDN store, MDN in-memory, PIX); with no indexable source it falls back to an LLM prompt."
---
