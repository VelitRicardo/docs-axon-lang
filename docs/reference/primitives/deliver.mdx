---
title: "deliver"
description: "Governed CRM write: `deliver` pushes assertions into a system of record with idempotent operations, per-tenant secrets and provenance kept attached."
---
