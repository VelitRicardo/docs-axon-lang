...
description: "Multi-file AXON project: a security module and an entry file that imports it, resolved, epistemically checked and linked into one deployable artifact."
---
