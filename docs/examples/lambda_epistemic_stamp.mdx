...
description: "Epistemic metadata stamp: a top-level `lambda` records ontology, certainty, time frame, provenance and derivation for the audit trail of each output."
---
