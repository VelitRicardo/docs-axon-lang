...
description: "HTTP QUERY method (RFC 10008): a safe, idempotent read with a request body; AXON proves at compile time that the flow behind it performs no writes."
---
