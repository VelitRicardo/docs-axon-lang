...
description: "Symbolic differentiation at compile time: `grad` derives a gradient into the IR and the runtime only evaluates it; non-differentiable code is refused."
---
