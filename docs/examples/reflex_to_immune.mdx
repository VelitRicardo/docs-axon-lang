...
description: "Fast defensive loop: an `immune` watches an observed signal and a `reflex` fires at a declared epistemic level, taking an action from a closed catalog."
---
