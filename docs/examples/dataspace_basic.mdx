...
description: "Analytical data store: a `dataspace` is a typed columnar schema over a closed type catalog, checked at compile time and run by the deterministic engine."
---
