...
description: "ReAct agent with tools and budgets: an `agent` binds tools, memory and a shield under a coordination strategy with iteration, token, time and cost limits."
---
