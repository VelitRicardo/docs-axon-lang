...
description: "Policy-as-code with PID control: a `mandate` declares a constraint the runtime enforces via kp/ki/kd gains; `on_violation:` is coerce, halt or retry."
---
