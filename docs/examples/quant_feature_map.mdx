...
description: "Quantum feature map: declare observables and run one `quant` block per observable to build a feature vector; the projected kernel is assembled classically."
---
