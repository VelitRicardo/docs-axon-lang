...
description: "Memory lifecycle scopes: each `memory` picks one `store:` (ephemeral, none, session, persistent); memories with different scopes coexist in one program."
---
