...
description: "Time-aware steps with `now:`: a context or step declares its IANA time zone and the runtime injects one captured instant per run, with no ambient clock."
---
