...
description: "REST endpoint exposing a flow over HTTP: `axonendpoint` sets method and path, binds a typed `body:` to the flow's parameters and returns a `FlowEnvelope`."
---
