---
title: "Installation"
description: "How to get the AXON compiler, what it needs from the host, and what the optional features actually cost."
---

## Getting AXON

AXON is licensed commercially — it is neither open source nor open core, and
there is no public package to install. Access to the compiler goes through
sales:

<ContactSales />

What you get is one binary, `axon`. The rest of this page is what it needs from
the host and what its optional features cost.
