...
The workspace is four crates: `axon-lang` (the runtime and CLI),
`axon-frontend` (lexer, parser, type checker, IR generator — zero runtime
dependencies), `axon-csys` (the C23 kernels) and `axon-agora` (the governed
social connectors).
