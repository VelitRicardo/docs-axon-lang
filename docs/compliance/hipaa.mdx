...
description: "HIPAA in AXON: which annotations cover which requirements; what the compiler enforces, what the runtime enforces, what you must still attest manually."
---
