...
description: "GDPR in AXON: lawful basis, data subject rights, cross-border transfers and audit; what the compiler checks, what the runtime enforces, what you attest."
---
