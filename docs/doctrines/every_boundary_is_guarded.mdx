...
description: "Endpoint authorization in AXON: every endpoint that runs a flow must declare requires, shield or compliance, or say public: true, or it does not compile."
---
