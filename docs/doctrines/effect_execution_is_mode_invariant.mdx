...
description: "Streaming vs JSON responses in AXON: structural effects such as navigate, persist or retrieve run the same handler with the same result in either mode."
---
