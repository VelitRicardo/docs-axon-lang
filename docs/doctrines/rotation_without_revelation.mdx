...
description: "Secrets management in AXON: secrets such as OAuth tokens are seeded, used, listed and rotated without their value ever reaching a prompt, a log or a flow."
---
