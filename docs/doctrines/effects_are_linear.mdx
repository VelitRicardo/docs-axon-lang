...
description: "Rate limits in AXON: an effect under a budget consumes a token from a rate bucket or max window; with none left it blocks, defers or sheds, never exceeds."
---
