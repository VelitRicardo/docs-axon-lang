...
description: "Required capabilities in AXON: a requires guard that no role or permission in the system can ever grant is a dead boundary, refused at deploy (axon-T891)."
---
