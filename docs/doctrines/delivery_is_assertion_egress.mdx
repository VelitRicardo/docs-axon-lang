...
description: "Writing to a CRM with deliver: each value lands with its provenance, or the author vouches it is verified; stripping a guess's origin does not compile."
---
