...
description: "Postgres pooling in AXON: with AXON_DB_POOLER_MODE set to session or direct, a flow releases its connection rather than hold it across an LLM step."
---
