...
description: "JSON access in AXON: navigating a Json value never panics (a missing field or bad index yields null), and a declared Json<T> shape is checked, never faked."
---
