...
description: "Ephemeral credentials with credential and mint: a token carries only capabilities its minter holds, for a bounded TTL, checked at compile, deploy and mint."
---
