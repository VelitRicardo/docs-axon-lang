...
description: "Tool calls in AXON: use Tool(k=v) is a deterministic, typed dispatch with no LLM involved; apply: Tool delegates the tool to the model. When to use each."
---
