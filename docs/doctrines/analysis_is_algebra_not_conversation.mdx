...
description: "Data analysis in AXON: five data-plane verbs run relational algebra on a deterministic columnar engine, so aggregates are computed, never narrated."
---
