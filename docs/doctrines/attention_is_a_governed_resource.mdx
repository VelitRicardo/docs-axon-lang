...
description: "Human notifications with notify: each alert carries its provenance, the recipient comes from secret custody, and a mandatory window caps interruptions."
---
