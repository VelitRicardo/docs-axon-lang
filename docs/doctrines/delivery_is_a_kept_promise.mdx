...
description: "Channel delivery guarantees in AXON: the qos and persistence a channel declares are enforced by the runtime (durable, retried, dead-lettered) or flagged."
---
