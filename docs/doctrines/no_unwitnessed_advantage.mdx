...
description: "Advantage claims in AXON: a primitive claiming to beat a cheaper baseline needs a witness measured on real data; without one it degrades to the baseline."
---
