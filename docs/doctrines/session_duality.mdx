...
description: "Session types for AXON WebSocket sessions: the duality, linearity, credit-based backpressure and multiparty projection rules the type checker enforces."
---
