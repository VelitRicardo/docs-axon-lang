...
description: "HTTP QUERY (RFC 10008) in AXON: an endpoint with method QUERY whose flow performs a write does not compile (axon-T927), and deploy re-derives the proof."
---
