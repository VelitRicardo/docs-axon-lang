...
description: "Per-tenant secrets in AXON: secret_partition lets a tool pick a sub-tenant's credential by parameter, without revealing it or leaving its declared class."
---
