...
description: "Symbolic gradients in AXON: grad differentiates a declared expression at compile time, with no tape and no finite differences, and deploy re-checks it."
---
