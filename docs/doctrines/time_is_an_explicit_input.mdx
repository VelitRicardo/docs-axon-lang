...
description: "Scheduling and time windows in AXON: whether something runs is a pure function of explicit inputs (now in UTC, timezone, allowed hours, holidays)."
---
