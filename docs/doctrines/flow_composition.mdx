...
description: "When to write an AXON operation as an inline step and when to lift it to a sub-flow invoked with apply: the decision rules for composing flows."
---
