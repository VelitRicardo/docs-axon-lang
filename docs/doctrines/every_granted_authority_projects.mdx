...
description: "RBAC in AXON: every permission granted to a principal, custom roles included, must be live at the gates that check it; a dead grant is refused or flagged."
---
