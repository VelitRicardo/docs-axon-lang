...
description: "Chat-with-skills scaffold: a router persona dispatches each user message to a typed skill sub-flow (Support, Sales, Billing) with its own types."
---
