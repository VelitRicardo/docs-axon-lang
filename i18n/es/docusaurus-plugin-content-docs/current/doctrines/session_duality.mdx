...
description: "Tipos de sesión para WebSocket en AXON: las reglas de dualidad, linealidad, contrapresión por créditos y proyección multiparte que aplica el verificador."
---
