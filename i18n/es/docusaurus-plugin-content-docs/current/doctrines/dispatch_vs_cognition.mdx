...
description: "Herramientas en AXON: use Tool(k=v) es un despacho determinista y tipado sin LLM; apply: Tool delega la herramienta al modelo. Cuándo usar cada una."
---
